    ...
    public class DashboardManager : IDashboardManager
    {
        ...
        private DashboardClassDetail PrepareDashboardDetails()
        {
            return new DashboardClassDetail
            {
                ...
                BusinessScore = new BusinessScore { TotalBusiness = 100, Score = 88 },
            ...
            return new List<ServiceRecommendationDetails>
            {
               new  ServiceRecommendationDetails
                ...
                new  ServiceRecommendationDetails
                {
                    ...
                    ScheduleFor = new ScheduleFor{Number = 180, MonthYear = "days" },
                 ...
                 new  ServiceRecommendationDetails
                {
                    ...
                    ScheduleFor = new ScheduleFor{Number = 1, MonthYear = "Year" },
